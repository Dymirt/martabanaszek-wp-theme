            ...
            <div class="text">
                <div class="desc">
                    <div class="content">
                        <h2>Krok I</h2>
                        <h3>Wybór tkaniny</h3>
                        <p>Na początku zaczynasz od wybrania tkaniny. Korzystając z naszej wiedzy znajdziesz materiał,
                            który będzie Ci najbardziej odpowiadał pod względem kolorystycznym oraz ze względu na
                            właściwości techniczne (gniecenie się, gramatura, przewiewność, skład). Weźmiemy pod uwagę
                            sytuacje, w których ubranie musi się sprawdzać i zaproponujemy najlepsze rozwiązanie.
                            Ostateczna decyzja należy do Ciebie, ale niezależnie od tego, czy będzie to garnitur ślubny
                            granatowy, czy smoking ślubny, pomożemy w wyborze.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="text">
                    <div class="desc">
                        <div class="content">
                            <h2>Krok I</h2>
                            <h3>Wybór tkaniny</h3>
                            <p>Na początku zaczynasz od wybrania tkaniny. Korzystając z naszej wiedzy znajdziesz
                                materiał, który będzie Ci najbardziej odpowiadał pod względem kolorystycznym oraz ze
                                względu na właściwości techniczne (gniecenie się, gramatura, przewiewność, skład).
                                Weźmiemy pod uwagę sytuacje, w których ubranie musi się sprawdzać i zaproponujemy
                                najlepsze rozwiązanie. Ostateczna decyzja należy do Ciebie, ale niezależnie od tego, czy
                                będzie to garnitur ślubny granatowy, czy smoking ślubny, pomożemy w wyborze.</p>
                        </div>
                    </div>
                </div>
            </div>
