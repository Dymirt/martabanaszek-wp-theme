    ...
    <header id="masthead" class="site-header black" role="banner" style="<?php storefront_header_styles(); ?>">
        ...
        <div class="header-row">
            ...
            <div class="header-col">
                ...
                ?>
                <a href="<?php echo get_site_url(); ?>" class="custom-logo-link " rel="home"><img width="276"
                                                                                                  height="67"
            ...
            <div class="header-col">
                ...
                <ul class="language-list d-none">
                    ...
                    <li><a class="underline"
                           href="<?php echo($translations['pl']['url']) ?>"><?php echo($translations['pl']['slug']) ?></a>
                    </li>
                    |
                    <li><a class="underline"
                           href="<?php echo($translations['en']['url']) ?>"><?php echo($translations['en']['slug']) ?></a>
                    </li>
                </ul>
                <?php
                wp_nav_menu(
