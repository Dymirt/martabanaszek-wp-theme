...
?>
	...
	<footer id="colophon" class="site-footer black" role="contentinfo">
		...
		<div id="ebook-link" class="ebook">
			<a class="ebook-link" href="<? echo get_site_url()?>/landing-stylebook/">
				<img class="ebook-bg" src="<? echo get_stylesheet_directory_uri()?>/img/btn_mobile_2_1.png"/>
			</a>
			<a class="ebook-close">
				<img src="<? echo get_stylesheet_directory_uri()?>/img/X_1.png"/>
			</a>
